...
def main():
    ...
    screen.disp.blit(bird.image, bird.rect)               # こうかとん画像用のSurfaceを画面用Surfaceに貼り付ける
    ...
    while True:
        ...
        # 練習8
        if bird.rect.colliderect(bomb.rect): return        # こうかとん用のRectが爆弾用のRectと衝突していたらreturn
